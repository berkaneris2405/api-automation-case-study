...
import mockapi.models.request.ProductDetails;
import mockapi.models.response.AuthLoginFailedResponse;
import mockapi.models.response.AuthLoginSuccessfulResponse;
import mockapi.models.response.CreateOrderFailedResponse;
import mockapi.models.response.CreateOrderResponse;
...
public class MockApiTest extends BaseTest {
	...
	public void testAuthLoginForSuccessfulUser() throws JsonProcessingException {
		...
		Response response = given().contentType(ContentType.JSON).body(loginRequest).when().post("/auth/login");
	...
	public void testCreateOrderRequestSuccessful() throws JsonProcessingException {
		...
		Response response = given().contentType(ContentType.JSON).body(createOrderRequest).when().post("/orders");
